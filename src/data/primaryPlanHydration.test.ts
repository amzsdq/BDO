...
describe('hydratePrimaryPlan', () => {
  ...
  it('preserves a valid intentionally empty persisted plan', () => { expect(hydratePrimaryPlan(sampleDataset, storage(JSON.stringify(persistedEmpty())))).toEqual({ status: 'restored-empty' }) })
