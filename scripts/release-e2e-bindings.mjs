...
export function assertReleaseE2eBindings({ evidence, dataset, reconciliation, reconciliationBytes, masteryEvidenceBytes, masteryBytes, iconManifestSha256, head }) {
  ...
  if (evidence.iconManifestSha256 !== iconManifestSha256) throw new Error('E2E evidence iconManifestSha256 does not match production icon-manifest.json bytes');
}
